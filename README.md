...
## 🚀 **Live Demo**
- **Main Portfolio**: [kestq.github.io](https://kestq.github.io)
- **Phasmo Journal**: [kestq.github.io/phasmo-journal](https://kestq.github.io/phasmo-journal)
...
├── styles.css              # Modern animated CSS with themes
├── script.js               # Interactive JavaScript functionality
├── README.md               # This file
└── phasmo-journal/         # Phasmo Journal sub-project
    ├── index.html          # Phasmo Journal application
    ├── styles.css          # Phasmo Journal themes (20 themes)
    ├── app.js              # Phasmo Journal logic
    ├── data.js             # Ghost data and utilities
    └── README.md           # Phasmo Journal documentation
```
...
- **3 Interactive Portal Buttons**:
  - 🔥 **Phasmo Journal** (Live) - Ghost evidence tracker with 20 themes
  - 🧪 **Interactive Lab** (Coming Soon) - Science simulations platform
  - 🎮 **3D Playground** (Coming Soon) - WebXR experiences
...
2. **Configure DNS**
   ```dns
   CNAME record: www.kestq.dev → yourusername.github.io
   A record: kestq.dev → 185.199.108.153
   ```
...
- **LinkedIn**: [/in/kestq](https://linkedin.com/in/kestq)
- **Twitter**: [@kestq_dev](https://twitter.com/kestq_dev)
